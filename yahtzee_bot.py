...
def inject_ui_overlay(page, min_delay=5.0, max_delay=10.0):
    ...
    ">
        <div style="font-weight: 800; font-size: 15px; margin-bottom: 10px; color: #10b981; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 8px;">
            <span style="letter-spacing: 0.5px;">YAHTZEE AI BOT</span>
            <span id="bot-status-indicator" style="font-size: 10px; font-weight: 700; text-transform: uppercase; padding: 2px 8px; border-radius: 9999px; background: #d97706; color: #fef3c7; transition: all 0.3s ease;">Paused</span>
        </div>
        ...
        <div id="match-scores-detail" style="font-size: 12px; margin-bottom: 12px; display: flex; justify-content: space-between; background: rgba(0,0,0,0.15); padding: 8px 12px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.05);">
            <span>You: <strong id="score-you" style="color: #f8fafc;">0</strong></span>
            <span>Opponent: <strong id="score-freda" style="color: #f8fafc;">0</strong></span>
        </div>
        ...
        <!-- Status Logs -->
        <div style="font-size: 11px; color: #94a3b8; text-transform: uppercase; font-weight: 600; margin-bottom: 4px;">Status Logs</div>
        <div id="bot-log" style="font-size: 12px; margin-bottom: 12px; color: #e2e8f0; line-height: 1.4; min-height: 42px; background: rgba(0,0,0,0.25); padding: 8px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.05); overflow-wrap: break-word;">
            Ready to start. Click "Start / Resume" to begin.
        </div>

        <!-- Collapsible Settings -->
        <div style="margin-bottom: 14px;">
            <div id="settings-toggle" style="font-size: 11px; color: #94a3b8; text-transform: uppercase; font-weight: 600; cursor: pointer; display: flex; justify-content: space-between; align-items: center; background: rgba(255,255,255,0.05); padding: 6px 8px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.03); user-select: none;">
                <span>Settings</span>
            ...
            <div id="settings-content" style="display: none; padding: 10px 4px 4px 4px; font-size: 12px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                    <span style="color: #94a3b8;">Min Think Delay:</span>
                    <div style="display: flex; align-items: center; gap: 4px;">
                        <input id="input-min-delay" type="number" min="0" max="30" value="5" style="width: 55px; background: #1e293b; border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; color: white; padding: 2px 4px; text-align: center; font-size: 12px;">
                        <span style="color: #64748b;">s</span>
                    </div>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: #94a3b8;">Max Think Delay:</span>
                    <div style="display: flex; align-items: center; gap: 4px;">
                        <input id="input-max-delay" type="number" min="0" max="30" value="10" style="width: 55px; background: #1e293b; border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; color: white; padding: 2px 4px; text-align: center; font-size: 12px;">
                        <span style="color: #64748b;">s</span>
                    </div>
                </div>
            </div>
        ...
        <!-- Controls Grid -->
        <div style="display: flex; gap: 8px; margin-bottom: 8px;">
            <button id="btn-bot-resume" style="flex: 1; padding: 8px 12px; border-radius: 6px; border: none; background: #10b981; color: white; font-weight: 600; font-size: 12px; cursor: pointer; transition: background 0.2s;">Start / Resume</button>
            <button id="btn-bot-pause" style="flex: 1; padding: 8px 12px; border-radius: 6px; border: none; background: #f59e0b; color: white; font-weight: 600; font-size: 12px; cursor: pointer; display: none; transition: background 0.2s;">Pause</button>
        </div>
        <div style="display: flex; gap: 8px;">
            <button id="btn-bot-restart" style="flex: 1; padding: 6px 12px; border-radius: 6px; border: none; background: #3b82f6; color: white; font-weight: 600; font-size: 12px; cursor: pointer; transition: background 0.2s;">Restart Bot</button>
            <button id="btn-bot-stop" style="flex: 1; padding: 6px 12px; border-radius: 6px; border: none; background: #ef4444; color: white; font-weight: 600; font-size: 12px; cursor: pointer; transition: background 0.2s;">Stop Bot</button>
        </div>
    </div>
    """.replace("SOLVER_MODE", "C++ Tablebase" if IS_TABLEBASE else "Heuristic").replace("SOLVER_COLOR", "#10b981" if IS_TABLEBASE else "#f59e0b")
